...
sys.path.insert(0,'/home/jogal002/python_workspace/DEC-keras/DEC-keras')
from datasets import load_mnist
from DEC import DEC, ClusteringLayer

lcolours = ['#CAA8F5', '#D6FF79', '#A09BE7', '#5F00BA', '#56CBF9', \
            '#F3C969', '#ED254E', '#B0FF92', '#D9F0FF', '#46351D']
mnist_results = "/home/jogal002/python_workspace/DEC-keras/DEC-keras/results"
...
def clickable_analysis(x_test, y_test):
  ae_weights  = mnist_results + '/ae_weights.h5'
  ...
  redec.model.load_weights(mnist_results + '/DEC_model_final.h5')
